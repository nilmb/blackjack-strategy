(function() {
  ...
  const surrenderOrStay = "Rendirse si está permitido, si no Quedarse";
  ...
  function checkSoftHands(playerHand, dealerCard) {
    const softStrategy = {
      'A,2': { 2: hit, 3: hit, 4: hit, 5: hit, 6: hit, 7: hit, 8: hit, 9: hit, 10: hit, 11: stay },
      'A,3': { 2: hit, 3: hit, 4: hit, 5: hit, 6: hit, 7: hit, 8: hit, 9: hit, 10: hit, 11: stay },
      'A,4': { 2: hit, 3: hit, 4: hit, 5: hit, 6: hit, 7: hit, 8: hit, 9: hit, 10: hit, 11: stay },
      'A,5': { 2: hit, 3: hit, 4: hit, 5: hit, 6: hit, 7: hit, 8: hit, 9: hit, 10: hit, 11: stay },
      'A,6': { 2: hit, 3: hit, 4: hit, 5: hit, 6: hit, 7: hit, 8: hit, 9: hit, 10: hit, 11: stay },
  ...
  function checkPairs(pairCard, dealerCard) {
    ...
    return pairsStrategy[pairCard]?.[dealerCard] || hit;
  }

  function checkHardHands(total, dealerCard) {
    const hardStrategy = {
      12: { 2: stay, 3: stay, 4: stay, 5: stay, 6: stay, 7: hit, 8: hit, 9: hit, 10: hit, 11: hit },
